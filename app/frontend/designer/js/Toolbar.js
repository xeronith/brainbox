...
export default class Toolbar {
  ...
  constructor(app, elementId, view) {
    ...
    this.shapeButton = $(
      ...
      '    <img   id="tool_shape_image" class="policyRectangleToolPolicy1 icon"  data-toggle="tooltip" title="Rectangle <span class=\'highlight\'> [ R ]</span>"  src="./images/toolbar_rectangle.svg">' +
      '    <span data-toggle="dropdown" role="button" href="#" id="tool_shape_caret"><span class="caret">&nbsp;</span></span>' +
      '    <ul class="dropdown-menu" role="menu" >' +
      '       <li class="tool_shape_entry policyRectangleToolPolicy2" data-toggle="tooltip" title="Rectangle <span class=\'highlight\'> [ R ]</span>"><a href="#"><img  src="./images/toolbar_rectangle.svg">Rectangle</a></li>' +
